    ...
    if (encodedData) {
      ...
      fetch(`${VITE_BACKEND_URL}/share/${encodedData}`, {
        ...
        .then((data) => {
          ...
          if (
            !data.other_data.currUser ||
            !data.other_data.timeframe ||
            !data.other_data.selectedDemographic ||
            !data.other_data.selectedValues ||
            data.other_data.selectedValues[0] === ""
          ) {
      ...
      {loading ? (
        ...
        <div className="share-page-content">
          <h1 className="page-title">
            Data by {data.currUser.split("@")[0]} (
            {data.timeframe.charAt(0).toUpperCase() + data.timeframe.slice(1)})
          </h1>
            ...
            <div className="demographics-container">
              <div className="demographic-item">
                ...
                <span className="demographic-value">
                  {data.selectedDemographic.charAt(0).toUpperCase() +
                    data.selectedDemographic.slice(1)}
                </span>
              ...
              <div className="demographic-item">
                ...
                <span className="demographic-value">
                  {data.secondSelectedDemographic.charAt(0).toUpperCase() +
                    data.secondSelectedDemographic.slice(1)}
                </span>
                <ul className="demographics-list">
