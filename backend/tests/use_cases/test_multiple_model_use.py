...
def test_execute_with_failure(mock_evaluate_multiple_models, mock_file_repo, mock_model_files):
    ...
    use_case = EvaluateModelsUseCase(file_repo=mock_file_repo, model_files=mock_model_files)
